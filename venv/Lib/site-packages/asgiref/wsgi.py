...
class WsgiToAsgi:
    ...
    async def __call__(self, scope, receive, send):
        ...
        We return a new WsgiToAsgiInstance here with the WSGI django_project
...
class WsgiToAsgiInstance:
    ...
    def run_wsgi_app(self, body):
        """
        Called in a subthread to run the WSGI django_project. We encapsulate like
